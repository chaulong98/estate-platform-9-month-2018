...
<c:url var="loadUser" value="/api/user"/>
                                            ...
                                            <div class="dt-buttons btn-overlap btn-group">
                                                ...
                                                <security:authorize ifAnyGranted="MANAGER">
                                                    <button id="btnDelete" type="button" disabled
                                                            ...
                                                            title='<spring:message code="label.building.delete"/>' onclick="warningBeforeDelete()">
															<span>
                                    ...
                                    <div class="table-responsive">
                                        <display:table name="model.listResult" cellspacing="0" cellpadding="0"
                                            ...
                                            <display:column style="width:2%" title="<fieldset class='form-group'>
												        <input type='checkbox' id='checkAll' class='check-box-element'></fieldset>" class="center select-cell"
                                                            headerClass="center select-cell">
                                                <fieldset>
                                                    <input type="checkbox" name="checkList" value="${tableList.id}" id="checkbox_${tableList.id}" class="check-box-element"/>
                                                </fieldset>
                                            </display:column>
                                            <display:column headerClass="text-left" style="width:7%" title="Ngày">
                                                <fieldset>
                                                    <fmt:formatDate pattern="dd/MM/yyyy" value="${tableList.modifiedDate}" />
                                                </fieldset>
                                            </display:column>

                                            <display:column headerClass="text-left" style="width:11%" property="name"
                                                            title="Tên Sản phẩm"/>
                                            <display:column headerClass="text-left" style="width:12%" property="address"
                                                            title="Địa chỉ"/>
                                            <display:column headerClass="text-left" style="width:10%"
                                                            property="managerName"
                                                            title="Tên quản lý"/>
                                            <display:column headerClass="text-left" style="width:14%"
                                                            property="managerPhone"
                                                            title="Số điện thoại"/>
                                            <display:column headerClass="text-left" style="width:3%"
                                                            property="buildingArea"
                                                            title="D.T sàn"/>
                                            <display:column headerClass="text-left" style="width:17%"
                                                            property="areaDescription"
                                                            title="D.T trống"/>
                                            <display:column headerClass="text-left" style="width:4%" property="costDescription"
                                                            title="Giá thuê"/>
                                            <display:column headerClass="text-left" style="width:4%"
                                                            property="serviceCost"
                                                            title="Phí dịch vụ"/>
                                            <display:column headerClass="text-left" style="width:4%"
                                                            property="commission"
                                                            title="Phí MG"/>
                                            <display:column headerClass="col-actions" style="width:12%"
                                                            title="Thao tác">
