...
<c:url var="formUrl" value="/login/dang-nhap"/>
...
<link rel="stylesheet"
	href="<c:url value ='/resouce/css/bootstrap.min.css'/>" />
<link rel="stylesheet"
	href="<c:url value ='/resouce/font-awesome/4.2.0/css/font-awesome.min.css'/>" />

<!-- text fonts -->
<link rel="stylesheet"
	href="<c:url value ='/resouce/fonts/fonts.googleapis.com.css'/>" />

<!-- ace styles -->
<link rel="stylesheet" href="<c:url value ='/resouce/css/ace.min.css'/>" />

<!--[if lte IE 9]>
			<link rel="stylesheet" href="assets/css/ace-part2.min.css" />
		<![endif] -->
<link rel="stylesheet"
	href="<c:url value ='/resouce/css/ace-rtl.min.css'/>">
<!--[if lte IE 9]>
...
<!--[if lt IE 9]>
		...
		<![endif] -->
<%-- <script src="<c:url value ='/resouce/JsCustom/custom.js'/>"></script> --%>
<script src="<c:url value ='/resouce/js/jquery.1.11.1.min.js'/>"></script>
<script src="<c:url value ='/resouce/js/jquery.2.1.1.min.js'/>"></script>
<script src="<c:url value ='/resouce/js/bootstrap.min.js'/>"></script>
...
<body class="login-layout">
									...
									<div class="widget-main">
										...
										<c:if test="${param.incorrectAccount != null}">
											<div class="alert alert-block alert-danger">
												<h5>Sai mật khẩu hay sai tài khoản</h5>
											</div>
										</c:if>
	...
	<!-- 	add file jquery tu viet  -->

	<script type="text/javascript"
		src="<c:url value ='/resouce/JsCustom/custom.js'/>"></script>
